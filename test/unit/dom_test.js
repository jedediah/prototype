...
new Test.Unit.Runner({
  ...
  testElementSelfInspect: function() {
    this.assertNothingRaised(function(){ Element.inspect(); },
                             "should be able to call Element.inspect on Element itself");
    this.assertNothingRaised(function(){ Element.Methods.inspect(); },
                             "should be able to call Element.Methods.inspect on Element.Methods itself");
  },
